...
{ 
 ...
 vars.ExtraItems = new List ()
 {
 28, 3, 48, 27, 34, 5, 37, 36, 43
 };

 vars.ExtraItemsSettings = new List ()
 {
...
{ 
 ...
 vars.doorIndexList = new List (); //Holds door indexes
...
{ 
 ...
 for(int i = 0; i < 8; i++)
 {
 vars.Inventory[i] = new DeepPointer(0x838814 + i*(0x2) - vars.inventoryOffset).Deref (game);
 }
