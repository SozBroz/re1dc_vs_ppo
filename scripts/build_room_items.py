...
ITEM_META: dict[str, tuple[str, int | None, bool, bool]] = {
    ...
    "Master Key": ("lab_key_2", 0x3C, True, True),
    "Laboratory Key": ("lab_key_2", 0x3C, True, True),
    ...
    "First Aid Spray": ("first_aid_spray_alt", 0x41, False, True),
    "Handgun Bullets": ("handgun_bullets", 0x0B, True, False),
...
def main() -> None:
    ...
    manual: list[tuple[str, str, int, str]] = [
        ...
        ("Mansion Storeroom", "Herbicide", 1, "on floor in corner"),
        ("Mansion Storeroom", "Shotgun Shells", 1, "Barry after Plant 42 (1x7 rounds)"),
        ("Mansion Storeroom", "First Aid Spray", 1, "Barry after Plant 42"),
        ("Mansion Storeroom", "Acid Rounds", 1, "Barry after Plant 42 (1x6)"),
        ("Greenhouse", "Armor Key", 1, "after chemical on plant; on crest"),
        ("Greenhouse", "Green Herb", 4, "benches next to fountain"),
        ("Greenhouse", "Red Herb", 2, "benches next to fountain"),
        ...
        ("Wardrobe", "Ink Ribbon", 2, "changing area west side"),
        ("Tiger Statue Room", "Wind Crest", 1, "blue jewel on tiger eye"),
        ("Tiger Statue Room", "Colt Python", 1, "red jewel alcove behind tiger statue"),
        ("Outside Boiler", "Green Herb", 6, "next to rusty boiler"),
