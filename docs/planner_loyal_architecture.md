...
- Fleet learner host: **WH3** `192.168.0.229`; WH2 = remote worker (24 envs). Thin cells (`RE1_YAWN_LEG_REPLAY=0`). Shield-key chunk complete ends the episode; mid-CP continues.
