...
def test_knife_action_ready_whitelist() -> None:
    ...
    assert knife_action_ready(0x12, 0x04, 0)
    assert knife_action_ready(0x13, 0x04, 0)
    assert knife_action_ready(0x13, 0x03, 0)
    assert knife_action_ready(0x14, 0x00, 0)
    assert knife_action_ready(0x14, 0x04, 0)
    assert knife_action_ready(0x14, 0x03, 0)
    assert knife_action_ready(0x16, 0x03, 0)
    assert not knife_action_ready(0x16, 0x03, 1)
    assert not knife_action_ready(0x13, 0x04, 2)
