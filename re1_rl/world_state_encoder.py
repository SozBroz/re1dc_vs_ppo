...
_KEY_PENDING_OFF = 2 * NUM_PICKUPS + NUM_ROOMS
_n_keys = len(KEY_ITEM_NAMES)
KEY_PICKUP_PENDING_SLICE = slice(_KEY_PENDING_OFF, _KEY_PENDING_OFF + _n_keys)
KEY_USE_PENDING_SLICE = slice(_KEY_PENDING_OFF + _n_keys, _KEY_PENDING_OFF + 2 * _n_keys)
KEY_AFFORDANT_HERE_SLICE = slice(_KEY_PENDING_OFF + 2 * _n_keys, _KEY_PENDING_OFF + 3 * _n_keys)

WORLD_STATE_DIM = _KEY_PENDING_OFF + KEY_HINTS_DIM
