...
PROPRIO_FIELDS: list[tuple[str, str]] = [
    ...
    ("anim_hist0_state", "player anim byte t-12 / 255"),
    ("anim_hist0_aux", "player action aux t-12 / 255"),
    ("anim_hist0_recovery", "recovery timer t-12 / 32"),
    ("anim_hist1_state", "player anim byte t-8 / 255"),
    ("anim_hist1_aux", "player action aux t-8 / 255"),
    ("anim_hist1_recovery", "recovery timer t-8 / 32"),
    ("anim_hist2_state", "player anim byte t-4 / 255"),
    ("anim_hist2_aux", "player action aux t-4 / 255"),
    ("anim_hist2_recovery", "recovery timer t-4 / 32"),
