...
class RE1Env(gym.Env):
    ...
    def _read_state(self, *, track_items: bool = True) -> dict[str, Any]:
        ...
        state_dict = {
            ...
            "armor_east_statue_z": int(ram.get("armor_east_statue_z", 0) or 0),
            "armor_east_statue_x_b": int(ram.get("armor_east_statue_x_b", 0) or 0),
            "armor_east_statue_z_b": int(ram.get("armor_east_statue_z_b", 0) or 0),
            "armor_east_statue_x_c": int(ram.get("armor_east_statue_x_c", 0) or 0),
            "armor_east_statue_z_c": int(ram.get("armor_east_statue_z_c", 0) or 0),
            "armor_west_statue_x": int(ram.get("armor_west_statue_x", 0) or 0),
            "armor_west_statue_z": int(ram.get("armor_west_statue_z", 0) or 0),
            "armor_west_statue_x_b": int(ram.get("armor_west_statue_x_b", 0) or 0),
            "armor_west_statue_z_b": int(ram.get("armor_west_statue_z_b", 0) or 0),
            "armor_west_statue_x_c": int(ram.get("armor_west_statue_x_c", 0) or 0),
            "armor_west_statue_z_c": int(ram.get("armor_west_statue_z_c", 0) or 0),
            "shed_stepladder_x": int(ram.get("shed_stepladder_x", 0) or 0),
            "shed_stepladder_z": int(ram.get("shed_stepladder_z", 0) or 0),
            "shed_stepladder_x_b": int(ram.get("shed_stepladder_x_b", 0) or 0),
            "shed_stepladder_z_b": int(ram.get("shed_stepladder_z_b", 0) or 0),
    ...
    def _termination_flags(
        ...
        armor_gas_failure = self._progress.armor_gas_breached
    ...
    def _apply_async_skip_timeout(self, breakdown: dict[str, float]) -> bool:
        ...
        blocked = (
            ...
            or bool(getattr(progress, "armor_gas_breached", False))
        )
        if blocked:
            return False
