...
def capture_planner_loyal_cell(
    ...
    *,
    ...
    # Kit/ammo bars gate march *advance* and fight-cap unlock
    # (planner_march / live_kit_meets_champion), not mint install. Soft tip_ok
    # cells must land so remints can improve them; the pin stays until kit clears.
